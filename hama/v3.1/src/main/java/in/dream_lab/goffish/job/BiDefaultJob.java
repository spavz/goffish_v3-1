...
import in.dream_lab.goffish.api.IBiAbstractSubgraphComputation;
import in.dream_lab.goffish.api.IVertex;
import in.dream_lab.goffish.hama.BiGraphJob;
...
public class BiDefaultJob {
  ...
  public static void main(String args[]) throws IOException,
    ...
    BiGraphJob job = new BiGraphJob(conf, (Class<? extends IBiAbstractSubgraphComputation>)Class.forName(computeClass));
    ...
    if (inputReaderClass != null)
      job.setInputReaderClass((Class<? extends IBiReader>)Class.forName(inputReaderClass));
