 ...
 */
public interface IBiSubgraphCompute<S extends Writable, V extends Writable, E extends Writable, M extends Writable, I extends Writable, J extends Writable, K extends Writable> {

  IBiSubgraph<S, V, E, I, J, K> getSubgraph();// templatize return type, G extends
  ...
  void setSubgraph(IBiSubgraph<S, V, E, I, J, K> subgraph);
