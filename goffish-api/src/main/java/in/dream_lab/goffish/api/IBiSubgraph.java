 ...
 * */
public interface IBiSubgraph<S extends Writable, V extends Writable, E extends Writable, I extends Writable, J extends Writable, K extends Writable> {

    IBiVertex<V, E, I, J, K> getVertexById(I vertexID);
    ...
    Iterable<IBiVertex<V, E, I, J, K>> getVertices();

    Iterable<IBiVertex<V, E, I, J, K>> getLocalVertices();

    Iterable<IBiRemoteVertex<V, E, I, J, K>> getRemoteVertices();

    Iterable<IBiEdge<E, I, J, K>> getOutEdges();

    IBiEdge<E, I, J, K> getEdgeById(J edgeID);

    void setSubgraphValue(S value);

    S getSubgraphValue();

    void addVertex(IBiVertex<V, E, I, J, K> v);
}
